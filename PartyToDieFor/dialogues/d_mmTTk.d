...
IF ~True() ~ THEN BEGIN 0
	SAY ~Oh, gods, <CHARNAME>! You have to help me! I… I wasn’t in control of myself. I swear upon all the gods that I didn’t kill the others, but <CHARNAME>… I don’t know what happened! It was as if my body belonged to someone else!~
		+~InParty("Skie")~+ ~You're lying.~ GOTO liar1
		+~!InParty("Skie")~+ ~You're lying.~ GOTO liar2
		+~InParty("Skie")~+ ~...what?~ GOTO liar1
		+~!InParty("Skie")~+ ~...what?~ GOTO liar2
		+~InParty("Skie")~+ ~A domination spell?~ GOTO liar1
		+~!InParty("Skie")~+ ~A domination spell?~ GOTO liar2
END

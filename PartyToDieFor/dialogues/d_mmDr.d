...
IF ~~ THEN DO ~ FadeToColor([20.0],0) Wait(1) FadeFromColor([20.0],0) ActionOverride(Player1,LeaveAreaLUA("g_mmih4","",[272.364],4)) ActionOverride(Player2,LeaveAreaLUA("g_mmih4","",[334.323],4)) ActionOverride(Player3,LeaveAreaLUA("g_mmih4","",[402.285],4)) ActionOverride(Player4,LeaveAreaLUA("g_mmih4","",[470.250],4)) ActionOverride(Player5,LeaveAreaLUA("g_mmih4","",[525.267],4)) ActionOverride(Player6,LeaveAreaLUA("g_mmih4","",[292.413],4)) SetGlobal("g_mmMQ1","GLOBAL",4) AdvanceTime(TEN_HOURS) RestParty()~ EXIT 
END
...
IF ~~ THEN DO ~ FadeToColor([20.0],0) Wait(1) FadeFromColor([20.0],0) ActionOverride(Player1,LeaveAreaLUA("g_mmih4","",[272.364],4)) ActionOverride(Player2,LeaveAreaLUA("g_mmih4","",[334.323],4)) ActionOverride(Player3,LeaveAreaLUA("g_mmih4","",[402.285],4)) ActionOverride(Player4,LeaveAreaLUA("g_mmih4","",[470.250],4)) ActionOverride(Player5,LeaveAreaLUA("g_mmih4","",[525.267],4)) ActionOverride(Player6,LeaveAreaLUA("g_mmih4","",[292.413],4)) SetGlobal("g_mmMQ1","GLOBAL",6) AdvanceTime(TEN_HOURS) RestParty()~ EXIT
END

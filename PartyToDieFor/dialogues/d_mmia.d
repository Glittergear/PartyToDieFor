...
IF ~~ yes
	SAY ~Very well. All aboard!~
		IF ~~ THEN DO ~ActionOverride(Player1,LeaveAreaLUA("g_mmi","",[1386.2669],4))
						...
						ActionOverride(Player4,LeaveAreaLUA("g_mmi","",[1470.2864],4))
						ActionOverride(Player5,LeaveAreaLUA("g_mmi","",[1486.2713],4))
						ActionOverride(Player6,LeaveAreaLUA("g_mmi","",[1409.2735],4))
						DestroySelf()~ EXIT
END
